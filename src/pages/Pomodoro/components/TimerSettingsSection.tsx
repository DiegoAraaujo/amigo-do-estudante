      ...
      <form className="flex flex-col gap-3">
        <div className="flex flex-col gap-2">
          ...
          <input
            ...
            name=""
            id=""
            className={`rounded-xl p-2 ${darkTheme ? "text-primary-dark bg-dark" : "text-primary-light bg-light"}`}
            value={focusTime}
            onChange={(e) => {
          ...
          />
          <p
            className={`text-xs ${darkTheme ? "text-muted-dark" : "text-muted-light"}`}
          >
        ...
        <div className="flex flex-col gap-2">
          ...
          <input
            ...
            name=""
            id=""
            className={`rounded-xl p-2 focus:outline-none ${darkTheme ? "text-primary-dark bg-dark" : "text-primary-light bg-light"}`}
            value={shortBreak}
            onChange={(e) => {
