...
const TopUsers = () => {
  ...
  return (
    ...
    >
      <h2
        className={`text-xl font-semibold sm:text-2xl md:text-2xl ${darkTheme ? "text-primary-dark" : "text-primary-light"} mb-6`}
      >
        Top Usuários
      </h2>
      <div className="flex flex-col gap-3">
        <div className="flex items-center gap-3">
          <p
            className={`${darkTheme ? "text-blue-600" : "text-primary-light"} text-lg font-bold`}
          >
            #1
          </p>
          <div
          ...
          <div className="flex flex-col gap-0.5">
            <p
              className={`${darkTheme ? "text-primary-dark" : "text-primary-light"} text-sm font-medium`}
            >
              Prof. Carlos
            </p>
            <p
